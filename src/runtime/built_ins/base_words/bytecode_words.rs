use crate::{
    ...
    lang::{
        code::{Instruction, Op},
        compilation::{InsertionLocation, process_token},
        tokenizing::Token,
    },
    runtime::{
...
fn word_code_insert_at_front(interpreter: &mut dyn Interpreter) -> error::Result<()> {
    ...
    interpreter.context_mut().insertion = if is_at_beginning {
